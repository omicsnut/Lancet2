...
* point to gcs link
* update docs
* add link to ebm model
* add note about cpu support
* remove section in docs
* update to full text link
* remove creation date
* update docs index page
* add biorxiv publication to docs
* add umami scripts block
* update docs with somatic scoring guide
* rename file
